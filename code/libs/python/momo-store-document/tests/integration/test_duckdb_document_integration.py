...
from momo_store_document.document import Document, DocumentMetadata
...
class TestDuckDBKnowledgeBaseIntegration:
    ...
    def duckdb_kb(self):
        ...
        backend = DuckDBDocumentBackend(":memory:")
...
class TestDuckDBFilePersistence:
    ...
    async def test_persistent_knowledge_base(self):
        ...
        try:
            ...
            backend1 = DuckDBDocumentBackend(db_path)
            ...
            backend2 = DuckDBDocumentBackend(db_path)
    ...
    async def test_database_recovery_after_crash(self):
        ...
        try:
            # Save documents
            backend = DuckDBDocumentBackend(db_path)
            ...
            new_backend = DuckDBDocumentBackend(db_path)
        ...
        complex_docs = [
            Document(
                ...
                metadata=DocumentMetadata(
                    source="complex_test",
                    author="alice",
                    project={"name": "alpha", "version": "1.0", "status": "active"},
            ...
            Document(
                ...
                metadata=DocumentMetadata(
                    source="complex_test",
                    author="bob",
                    project={"name": "beta", "version": "2.0", "status": "active"},
                    metrics={"score": 0.87, "count": 150},
