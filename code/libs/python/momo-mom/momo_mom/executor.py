...
class CommandExecutor:
    ...
    def __init__(self, config: Dict[str, Any], verbose: bool = False, ai_output: bool = True):
        self.config = config
    ...
    def _execute_with_retries(self, command_template: str, context: Dict[str, Any], current_task: str = "") -> bool:
    ...
    def _execute_shell_command(self, command: str, cwd: Optional[Path] = None, current_task: str = "") -> bool:
        ...
        try:
            ...
            if self.ai_output:
                ...
                if result.had_interactions:
                    ...
                    formatted_output.metadata['interactions'] = len(result.interaction_log)
