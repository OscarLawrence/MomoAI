...
class BackendInterface:
    ...
    async def search(self, query: str, filters: Optional[Dict] = None, top_k: int = 10) -> SearchResult:
...
class KnowledgeBaseCore:
    ...
    async def _route_insert(self, item: Union[Document, Relationship]) -> Dict[str, str]:
