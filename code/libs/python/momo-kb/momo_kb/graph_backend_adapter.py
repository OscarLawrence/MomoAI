...
class GraphBackendAdapter(BackendInterface):
    ...
    def _graph_node_to_document(self, node: GraphNode) -> Document:
        ...
        # Parse timestamps
        created_at = datetime.fromisoformat(props.pop("created_at", datetime.utcnow().isoformat()))
        updated_at = datetime.fromisoformat(props.pop("updated_at", datetime.utcnow().isoformat()))
    ...
    def _apply_filters(self, documents: List[Document], filters: Dict) -> List[Document]:
        ...
        for doc in documents:
            ...
            for filter_key, filter_value in filters.items():
                if filter_key == "type" and doc.type.value != filter_value:
                    ...
                    matches = False
                    break
                elif filter_key in doc.properties and doc.properties[filter_key] != filter_value:
                    matches = False
                    break
