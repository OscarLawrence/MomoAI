...
class ThreeTierStorage:
    ...
    def move_node(self, node_id: str, from_tier: StorageTier, to_tier: StorageTier) -> bool:
    ...
    def move_edge(self, edge_id: str, from_tier: StorageTier, to_tier: StorageTier) -> bool:
