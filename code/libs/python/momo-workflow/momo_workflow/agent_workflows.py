...
class AgentGuardedWorkflow:
    ...
    def create_feature_workflow(self, module: str, feature: str) -> WorkflowDefinition:
        ...
        steps = [
            ...
            IntegrationGuardStep(
                "integrate",
                f"Test {feature} integration",
                module,
                feature,
                self.command_executor,
            ),
            DocumentationGuardStep(
                "document",
                f"Document {feature}",
                module,
                feature,
    ...
    def create_bugfix_workflow(self, module: str, issue: str) -> WorkflowDefinition:
        ...
        steps = [
            ...
            ReproductionStep(
                "reproduce", f"Reproduce {issue}", module, issue, self.command_executor
            ),
            TDDGuardStep(
                "test_fix",
                f"Create test for {issue} fix",
                module,
                issue,
                self.command_executor,
            ),
